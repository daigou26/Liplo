        ...
        >
          <template v-slot:items="props">
            <n-link class="clickable" tag="tr" :to="'/admin/paidActions/' + props.item.paidActionId">
              ...
              <td style="min-width: 150px">
                <span v-if="props.item.plan == 0" class="teal--text font-weight-bold">ベーシック</span>
                <span v-if="props.item.plan == 1" class="red--text font-weight-bold">スタンダード</span>
                <span v-if="props.item.plan == 2" class="blue--text font-weight-bold">アドバンス</span>
              </td>
