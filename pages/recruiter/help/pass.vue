<template>
  ...
  >
    ...
    >
      ...
      <div class="pt-3">
        パスとは、企業がインターン終了後の候補者に送ることのできるもので、
        内定取得や入社の権利を与えることが出来ます。パスの種類は現在、以下の３種類です。
        一度パスを発行すると、取り消すことが出来ないのでご注意ください。
        （有効期限などの変更は可能です）
        <div class="pt-3">
          ...
          <div class="pt-2">
            企業が定めた期間内であれば、いつでも入社できる権利を与えることが出来ます。
        ...
        <div class="pt-3">
          ...
          <div class="pt-2">
            企業が定めた期間内であれば、内定を取得できる権利を与えることが出来ます。
            <div>
      ...
      <div class="pt-3">
        候補者管理画面にて、ステータスをインターンからパスに変更することで、
        パスの入力フォームが表示され、種類や有効期限などを入力してからステータスを更新することで、
        候補者にパスが送られます。
      </div>
      <div class="pt-5 subheading font-weight-bold">
        パスの内容を変更するには？
      ...
      <div class="pt-3">
        パスの内容は、候補者管理画面から編集することが出来ます。
        <div>
          ただし、変更出来るのは、パスの有効期限、入社年度のみで、
          パスの種類は変更することが出来ないのでご注意ください。
        </div>
      </div>
