...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      rating: state => state.companyInfo.rating,
      currentCandidates: state => state.companyInfo.currentCandidates,
      candidatesChartData: state => state.companyInfo.candidatesChartData,
      allCandidates: state => state.companyInfo.allCandidates,
      feedback: state => state.companyInfo.feedback,
      reviewsChartData: state => state.companyInfo.reviewsChartData,
      feedbacksChartData: state => state.companyInfo.feedbacksChartData,
      feedbacksChartOptions: state => state.companyInfo.feedbacksChartOptions,
  ...
  methods: {
    ...mapActions({
      queryCompany: 'companyInfo/queryCompany',
